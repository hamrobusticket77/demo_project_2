...
import 'package:krishi_hub/feature/phone_book/ui/page/office_page.dart';
import 'package:krishi_hub/feature/phone_book/ui/widget/phone_book_card.dart';

class PhoneBookWidget extends StatefulWidget {
  const PhoneBookWidget({Key? key}) : super(key: key);

  @override
  State<PhoneBookWidget> createState() => _PhoneBookWidgetState();
}

class _PhoneBookWidgetState extends State<PhoneBookWidget> {
  ...
  void _scrollListener() {
    if (_scrollController.offset >=
      ...
      context.read<GetPhoneBookCubit>().loadMorePhoneList();
    }
  }
  ...
  Widget build(BuildContext context) {
    final phoneBook =
        RepositoryProvider.of<AllPhoneBookRepository>(context).getPhoneBookList;

    return Scaffold(
      appBar: CustomAppBar(
        title: LocaleKeys.agricultureBranchContact.tr(),
      ),
      body: SingleChildScrollView(
        ...
        child: Column(
          children: [
            ...
            BlocBuilder<GetPhoneBookCubit, CommonState>(
                ...
                if (state is CommonLoading) {
                  ...
                  return Column(
                    children: List.generate(state.data.length, (index) {
                      final data = phoneBook[state.data[index]];
                      if (data != null) {
                        return SizedBox(
                          child: PhoneBookCard(
                            onPressed: () {
