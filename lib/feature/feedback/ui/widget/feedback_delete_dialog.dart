...
Future deleteFeedbackDialog(
    {required BuildContext context, required Function() onPressed}) {
  return showDialog(
      context: context,
      builder: (context) => DeleteFeedbackDialogWidget(
            onPressed: onPressed,
          ));
}

class DeleteFeedbackDialogWidget extends StatelessWidget {
  final Function() onPressed;

  const DeleteFeedbackDialogWidget({super.key, required this.onPressed});
    ...
    return AlertDialog(
      ...
      actions: [
        ...
        SizedBox(
          width: 130,
          height: 34,
          child: BlocListener<DeleteFeedback, CommonState>(
            listener: (context, state) {
              ...
              if (state is CommonSuccess) {
                ...
                CustomToast.success(message: "Feedback  Deleted Successfully");
              }
            },
            child: BlocBuilder<DeleteFeedback, CommonState>(
