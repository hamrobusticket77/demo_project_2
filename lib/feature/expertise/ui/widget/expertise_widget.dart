...
import 'package:krishi_hub/feature/expertise/ui/page/expertise_detail_page.dart';
...
class _ExpertiseWidgetState extends State<ExpertiseWidget> {
  ...
  Widget build(BuildContext context) {
    final expertise =
        RepositoryProvider.of<AllExpertiseRepository>(context).getExpertise;
    return Scaffold(
      key: scaffoldKey,
      // appBar: CustomAppBar(
      //   title: LocaleKeys.expertis.tr(),
      // ),
      endDrawer: ProductFilterDrawer(
        ...
        onFilterUpdate: (market, type, category, product) {
          ...
          setState(() {});
          context.read<ExpertiseCubit>().getExpertise(
                category: category?.id,
                type: type?.type,
              );
        },
      ),
      body: BlocListener<ExpertiseCubit, CommonState>(
          ...
          child: SingleChildScrollView(
            child: Column(
              children: [
                ...
                BlocBuilder<ExpertiseCubit, CommonState>(
  ...
  void _handleSearch(String value) {
    SearchUtils().search(() {
      context.read<ExpertiseCubit>().getExpertise(search: value);
    });
  }
}
