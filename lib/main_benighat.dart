...
import 'package:krishi_hub/common/app/app_benighat.dart';
...
void main() async {
  runZonedGuarded(() async {
    ...
    await AwesomeNotifications().initialize(
      ...
      [
        NotificationChannel(
          channelKey: NotificationUtils.notificationChannelKeyBenighat,
          channelName: 'default_notification_channel',
          channelDescription: 'Default Notification Channel for Benighat.',
    ...
    SystemChrome.setPreferredOrientations([DeviceOrientation.portraitUp])
      ...
      runApp(
        LocalWrapper(
          child: App(env: EnvValue.benighat),
        ),
